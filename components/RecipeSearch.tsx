...
export default function RecipeSearch({
  ...
  const filteredRecipes = recipes
    .filter((recipe) => {
      ...
      else if (activeFilter === "시간단축")
        matchesFilter = recipe.cookingTime <= 20;
      else if (activeFilter === "만들기쉬운")
        matchesFilter =
          recipe.availableIngredients >= recipe.totalIngredients * 0.7;
    ...
    .sort((a, b) => {
      switch (sortBy) {
        case "available":
          return (
            b.availableIngredients / b.totalIngredients -
            a.availableIngredients / a.totalIngredients
          );
        case "time":
        ...
        <div className="lg:grid lg:grid-cols-4 lg:gap-8">
          ...
          <div className="lg:col-span-1 mb-6 lg:mb-0">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-[#E5E7EB]">
              ...
              <Link
                href="ai-recommend"
                className="block mt-6 bg-gradient-to-br from-[#10B981] to-[#059669] rounded-xl p-4 text-white cursor-pointer hover:shadow-lg transition-all duration-200 relative overflow-hidden"
              >
          ...
          <div className="lg:col-span-3">
                ...
                {filteredRecipes.map((recipe) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* 레시피 정보 */}
                      <div>
                        <h3 className="font-bold text-[#374151] mb-2 text-lg">
                          {recipe.name}
                        </h3>
            ...
            <div className="lg:hidden mt-8">
              <Link
                href="ai-recommend"
                className="inline-block bg-gradient-to-br from-[#10B981] to-[#059669] rounded-2xl p-6 text-white cursor-pointer hover:shadow-lg active:scale-[0.98] transition-all duration-200 relative overflow-hidden"
              >
                ...
                <div className="relative flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white/90">
                      원하는 레시피를 찾지 못하셨나요? AI가 특별한 레시피를
                      추천해드려요!
                    </p>
                  </div>
                </div>
