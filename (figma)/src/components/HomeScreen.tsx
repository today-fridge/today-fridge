import { TrendingUp, AlertCircle, RefrigeratorIcon, Sparkles } from 'lucide-react';
...
export default function HomeScreen({ ingredients, recipes, onNavigate, onRecipeSelect }: HomeScreenProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-6 lg:py-8 pb-20 md:pb-8">
        ...
        <div className="text-center mb-8 lg:mb-12">
          <h1 className="text-2xl lg:text-4xl font-bold text-[#374151] mb-2">
            당신의 냉장고가 <span className="text-[#10B981]">스마트</span>해집니다
          </h1>
          ...
          <button
            ...
            className="bg-[#10B981] text-white px-8 py-3 rounded-xl font-medium hover:bg-[#059669] transition-all duration-200 shadow-lg hover:shadow-xl active:scale-95 lg:px-12 lg:py-4 lg:text-lg"
          >
            시작하기 🚀
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-[#E5E7EB] h-full hover:shadow-md transition-shadow duration-200">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-lg font-semibold text-[#374151]">내 냉장고 현황</h2>
              </div>
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-center justify-between p-4 bg-[#FEF2F2] rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[#374151] font-medium">유통기한 임박</span>
                  </div>
                  <span className="text-2xl font-bold text-[#EF4444]">{expiringSoon.length}개</span>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-[#F0FDF4] rounded-xl">
                  ...
                  <span className="text-2xl font-bold text-[#10B981]">{totalIngredients}개</span>
                </div>
              </div>
              
              <button
                onClick={() => onNavigate('fridge')}
                className="w-full bg-[#10B981] text-white py-3 rounded-xl font-medium hover:bg-[#059669] transition-all duration-200 shadow-sm hover:shadow-md"
              >
                냉장고 관리하기
              </button>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="text-[#6B7280]">보유하신 재료로 만들 수 있는 맛있는 레시피들이에요</p>
            </div>
            ...
            <div className="space-y-4">
              {recipes.slice(0, 3).map((recipe) => (
                <div 
                  ...
                  className="bg-white rounded-2xl p-5 shadow-sm border border-[#E5E7EB] cursor-pointer hover:shadow-md hover:border-[#10B981]/20 active:scale-[0.98] transition-all duration-200"
                >
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-[#374151] mb-2 text-lg truncate">{recipe.name}</h3>
                      <div className="mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex items-center gap-1 bg-[#F0FDF4] px-3 py-1 rounded-full">
                          <span className="text-[#10B981] text-sm">✅ {recipe.availableIngredients}개 보유</span>
                        </div>
                        <span className="text-[#6B7280] text-sm">/ {recipe.totalIngredients}개 필요</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-12 lg:mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-6">
            ...
            <p className="text-[#6B7280] text-sm">유통기한을 자동으로 추적해서 음식 낭비를 줄여요</p>
          </div>
          <div className="text-center p-6">
            <div className="text-4xl mb-3">🍽️</div>
            <h3 className="font-semibold text-[#374151] mb-2">맞춤 레시피</h3>
            <p className="text-[#6B7280] text-sm">보유 재료를 기반으로 한 개인화된 요리 추천</p>
          </div>
          <div className="text-center p-6">
            <div className="text-4xl mb-3">📊</div>
            <h3 className="font-semibold text-[#374151] mb-2">요리 기록</h3>
            <p className="text-[#6B7280] text-sm">요리 히스토리를 기록하고 성취감을 느껴보세요</p>
          </div>
        </div>
      </div>
    </div>
