...
export default function Fridge() {
  ...
  const filteredIngredients = ingredients
    .filter((ingredient) => {
      const matchesCategory =
        activeCategory === "전체" || ingredient.category === activeCategory;
  ...
  const expiryFilters = [
    {
      key: "all" as ExpiryFilter,
      label: "전체",
      count: ingredients.length,
      color: "#6B7280",
    },
    {
      key: "safe" as ExpiryFilter,
      label: "안전",
      count: safeCount,
      color: "#10B981",
    },
    {
      key: "warning" as ExpiryFilter,
      label: "주의",
      count: warningCount,
      color: "#F59E0B",
    },
    {
      key: "urgent" as ExpiryFilter,
      label: "임박",
      count: urgentCount,
      color: "#EF4444",
    },
                ...
                {expiryFilters.map((filter) => (
                  <button
                    ...
                    style={{
                      ...
                      color:
                        expiryFilter === filter.key ? "white" : filter.color,
                    }}
                  >
