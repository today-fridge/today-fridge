              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {urgentIngredients.map((ingredient) => (
                    ...
                    >
                      {ingredient.emoji} {ingredient.name} (D-
                      {ingredient.daysLeft})
                    </div>
                  ))}
                </div>
        ...
        <div className="bg-gradient-to-br from-[#10B981] to-[#059669] rounded-2xl p-1 mb-8 shadow-lg">
          <div className="bg-white rounded-xl p-6">
            ...
            <Link
              ...
              className="block bg-gradient-to-r from-[#F59E0B]/5 to-[#10B981]/5 border-2 border-[#F59E0B]/20 rounded-xl p-5 cursor-pointer hover:shadow-md active:scale-[0.98] transition-all duration-200"
            >
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    <div className="flex items-center gap-1 bg-[#F0FDF4] px-3 py-1 rounded-full">
                      ...
                      <span className="text-[#10B981] text-sm font-medium">
                        {aiRecommendedRecipe.availableIngredients}/
                        {aiRecommendedRecipe.totalIngredients}개 보유
                      </span>
                    </div>
                    <span className="text-sm text-[#6B7280]">
                      ...
                      {Math.round(
                        (aiRecommendedRecipe.availableIngredients /
                          aiRecommendedRecipe.totalIngredients) *
                          100
                      )}
                      %
                    </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="space-y-3 text-[#047857] text-sm">
              ...
              <div className="flex items-start gap-2">
                <span className="text-[#10B981] font-bold">•</span>
                <span>
                  영양 균형과 칼로리까지 고려한 건강한 레시피만 추천해요
                </span>
              </div>
            </div>
          </div>
